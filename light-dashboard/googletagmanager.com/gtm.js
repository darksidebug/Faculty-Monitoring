...
(function(){
    ...
    "resource": {
      ...
      "rules":[
        [["if",0],["add",0,8,6,7]],
        [["if",1,2],["add",1]],
        [["if",0,3,4],["unless",5,6,7],["add",2]],
        [["if",0],["unless",5,8,9],["add",3]],
        [["if",0,5],["add",4]],
        [["if",0,7],["add",5]]]
    },
    "runtime":[
